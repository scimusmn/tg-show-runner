...
const CueServerLookup = {
  ...
  PRE_SHOW: 'CUE 1 Go',
  SHOW_START: 'CUE 2 Go',
  HIGHLIGHT_POSTER: 'CUE 2.1 Go',
  BEE_ACTIVATE: 'CUE 2.2 Go',
  ...
  // Unused
  BEE_DROP_LINE: 'CUE 99 Go',

  GAME_2_PRESHOW: 'CUE 40 Go', 
  GAME_2_BEE_ACTIVATE: 'CUE 41 Go', 

  GAME_2_BADGE_V: 'CUE 45 Go',
  GAME_2_BADGE_I: 'CUE 46 Go',
  GAME_2_BADGE_S: 'CUE 47 Go',
  GAME_2_BADGE_T: 'CUE 48 Go',
  GAME_2_BADGE_A: 'CUE 49 Go',

  FIREWORKS_FINALE: 'CUE 50 Go',
  VISTA_DROP: 'CUE 62 Go',
  VISTA_PICKUP: 'CUE 66 Go',
